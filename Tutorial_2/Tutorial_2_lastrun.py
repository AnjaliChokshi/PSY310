...
expName = 'Tutorial_2'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\hp\\Documents\\Anjali Assignments\\Lab in Psych\\Tutorial_2_lastrun.py',
